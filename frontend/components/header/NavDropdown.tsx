...
export default function NavDropdown({ 
  ...
  const mobileStyles = isMobile ? {
    ...
    wrapper: "relative",
    button: "flex items-center gap-1 text-white/80 hover:text-white transition-colors py-2 px-1 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary-light/70 text-sm lg:text-base",
